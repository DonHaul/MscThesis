...
setup(
  ...
  description = 'Multi Camera Network Calibration using Aruco',   # Give a short description about your library
  ...
  keywords = ['Camera', 'Calibration', 'System', 'Aruco'],   # Keywords that define your package best
